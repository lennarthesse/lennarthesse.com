<svelte:head>
    <title>Datenschutz | Lennart Hesse Design & Development</title>
</svelte:head>

<div class="bg-light-gray">
    <section id="datenschutz" class="bg-light shadow">
        ...
        <p>Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber. Dessen Kontaktdaten können Sie dem Abschnitt <a href="/datenschutz/#verantwortlicher">Hinweis zur verantwortlichen Stelle</a> in dieser Datenschutzerklärung entnehmen.</p>
        ...
        <h3 id="verantwortlicher">Hinweis zur verantwortlichen Stelle</h3>
